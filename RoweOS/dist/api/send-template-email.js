...
function buildBrillianceTransition(userName, recipientId) {
  ...
  parts.push('<p style="color:#f0e6d3;font-family:Georgia,serif;font-size:22px;line-height:1.4;font-weight:400;margin:0 0 14px;">RoweOS is now Brilliance.</p>');
  parts.push('<p style="color:#cfcfcf;font-size:14px;line-height:1.75;margin:0 0 12px;">Same platform you\'ve been using. Same memory of every brand and every life you\'ve built inside it. Same work waiting where you left it.</p>');
  parts.push('<p style="color:#cfcfcf;font-size:14px;line-height:1.75;margin:0 0 28px;">What\'s changed is the name, the orb, and a quiet rebuild of how the surfaces feel when you sit down at them. Brilliance has always been the intelligence inside RoweOS. We finally gave it a face.</p>');
