...
function generateSubscriptionInfoPreview() {
  ...
  var body = '<p style="color:#ccc;font-size:15px;line-height:1.6;margin:0 0 16px;">' + _emailGreeting() + '</p>'
    ...
    + '<p style="margin:0;font-size:12px;color:#888;">Latest: Opus 4.8, Sonnet 4.6, Haiku 4.5 + mini app building</p></div>'
    + '<div style="background:#1a1a1a;border:1px solid #2a2a2a;border-radius:8px;padding:14px 16px;margin:0 0 10px;">'
...
function generateFounderLifetimeOfferPreview() {
  ...
  var body = ''
    ...
    + providerLogo('Anthropic', 'Opus 4.8', '#d4b896', '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" style="vertical-align:middle;"><path fill="#d4b896" d="M17.3041 3.541h-3.6718l6.696 16.918H24Zm-10.6082 0L0 20.459h3.7442l1.3693-3.5527h7.0052l1.3693 3.5528h3.7442L10.5363 3.5409Zm-.3712 10.2232 2.2914-5.9456 2.2914 5.9456Z"/></svg>')
    ...
    + '</tr></table>'
    + '<p style="color:#666;font-size:11.5px;margin:14px 0 0;line-height:1.5;">Claude · Opus 4.8, Sonnet 4.6 · GPT-5.5 family + High Reasoning · Gemini 3.1 Pro · Nano Banana 3 Pro · Imagen 4 · Veo 3.1</p>'
    + '</div>'
