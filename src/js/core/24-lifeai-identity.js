...
function showRoweOSAISplash() {
  ...
  html += '</div>';
  html += '<div>';
  html += '<div style="font-size:11px;letter-spacing:0.15em;text-transform:uppercase;color:var(--accent,#a89878);margin-bottom:2px;">RoweOS AI</div>';
  html += '<div style="font-size:18px;font-weight:400;color:var(--text-primary);">Don\'t pick a model. Let RoweOS pick for you.</div>';
  html += '</div>';
  html += '</div>';
  ...
  html += '<div style="font-weight:600;color:var(--text-primary);margin-bottom:4px;">Keep RoweOS AI (Recommended)</div>';
